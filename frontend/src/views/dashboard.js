...
export function renderDashboard({onOpenTool, onOpenSettings}) {
        ...
        <div class="app-shell">
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <button class="settings-icon" id="settings-button" aria-label="打开设置" title="设置">
    ...
    document.getElementById('settings-button').addEventListener('click', () => onOpenSettings());
